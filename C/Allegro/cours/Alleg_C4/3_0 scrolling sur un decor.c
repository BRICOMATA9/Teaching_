...
int main()
{
    ...
    while (!key[KEY_ESC])
    {
        ...
        // Affichages ancrés à l'écran réel : pas de prise en compte de screenx et screeny
        ...
        textprintf_centre_ex(page, font, 320, 10, makecol(255,255,255), -1,"APPUYER SUR LES FLECHES POUR SCROLLER");
